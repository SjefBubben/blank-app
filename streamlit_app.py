                ...
                with col1:
                    st.markdown(f"""
                        <div style="padding: 15px; background-color: #4CAF50; color: white; border-radius: 10px; text-align: center;">
                            ...
                            <h4>Reaksjonstid: {min_rt} - {details["mapName"]} <br> ({datetime.strptime(details["finishedAt"], "%Y-%m-%dT%H:%M:%S.%fZ").strftime("%d.%m.%Y %H:%M")})</h4>
                        </div>
                ...
                with col2:
                    st.markdown(f"""
                        <div style="padding: 15px; background-color: #F44336; color: white; border-radius: 10px; text-align: center;">
                            ...
                            <h4>Reaksjonstid: {max_rt} - {details["mapName"]} <br> ({datetime.strptime(details["finishedAt"], "%Y-%m-%dT%H:%M:%S.%fZ").strftime("%d.%m.%Y %H:%M")})</h4>
                        </div>
                    """, unsafe_allow_html=True)
